    ...
    <div class="CouponList">
        ...
        <el-row :gutter="20" class="CouponList-Info">
            <el-col :xs="6" :sm="4" :md="3" :lg="2" :xl="2" :offset="1">
                <el-button type="primary" class="CouponList-Info-li" size="small" @click="CouponListShow = true">添加优惠券
                </el-button>
            </el-col>
        </el-row>
        <!-- 查询列表 -->
        ...
        <el-dialog title="添加优惠券" :visible.sync="CouponListShow">
            <el-form :model="CouponListForm" :rules="CouponListRules" ref="CouponListForm">
                ...
                <el-form-item label="优惠券金额" :label-width="CouponListWidth" prop="amount">
                    <el-input-number v-model="CouponListForm.amount" :precision="2" :step="0.1" :min="0.10"
                                     :max="1000"></el-input-number>
                </el-form-item>
                <el-form-item label="最低满减金额" :label-width="CouponListWidth" prop="sum">
                    <el-input-number v-model="CouponListForm.sum" :precision="2" :step="0.1" :min="0.00"
                                     :max="1000"></el-input-number>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        mounted() {
            var s = '6.jpg'
            this.json.list[0].src=require('E:/picturecore/传统/'+s)
        },
        ...
        data() {
            ...
            return {
                ...
                CouponListWidth: '120px',
                    ...
                    list:[
                        {
                            src: require('E:/picturecore/传统/2.jpg'),
                            des:'这是第一个描述',
                            price:198
                        },
                        {
                        ...
                        {
                            src: require('E:/picturecore/传统/3.jpg'),
                            des:'这是第三个描述',
                            price:211
                        },
                        {
                            src: require('E:/picturecore/传统/1.jpg'),
                            des:'这是第一个描述',
                            price:198
                        },
                        {
